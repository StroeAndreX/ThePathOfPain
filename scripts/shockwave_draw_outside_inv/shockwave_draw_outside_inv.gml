/// @description  shockwave_draw_outside_inv()

/// @description        Draw only the OUTSIDE of the shockwave effect using inverted alpha and texture values
...
repeat (wave_segment + 1)
    ...
    _xx = _wave_tex_x * (_xx - _vx);
    _yy = _wave_tex_y * (_yy - _vy);
