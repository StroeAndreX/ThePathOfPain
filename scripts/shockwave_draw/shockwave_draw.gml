...
wave_surf_w = room_width//surface_get_width(wave_surf);
wave_surf_h = room_height//surface_get_height(wave_surf);
...
if wave_view > -1
    {
		var _vx = __view_get( e__VW.XView, wave_view );
		var _vy = __view_get( e__VW.YView, wave_view );
    }
else
    {
    var _vx = 0;
