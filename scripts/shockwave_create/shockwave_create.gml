/// @description  shockwave_create(x, y, depth, view, width, max_radius, speed, segments, push, [update], [colour], [additive]);
/// @param x
/// @param  y
/// @param  depth
/// @param  view
...
var _i = instance_create(argument[0], argument[1], obj_Shockwave);
